    ...
    <header className="header-container">
      <div className="header-content">
        <Link to="/" className="header-logo-container">
          <img
            src={iconGif}
            alt="PlantaGamer Icon"
            className="header-logo-gif"
          />
        </Link>
        ...
        <div className="header-actions">
          ...
          <button className="dev-reset-btn" onClick={handleDevReset} title="Resetar Planta (Dev)">
            <Trash2 size={16} />
          </button>
          <Link to="/profile">
            <div
              className={`profile-avatar-container ${isProfile ? "active" : ""}`}
            >
              <img
