  ...
  return (
    <div className="welcome-container">
      <div className="welcome-content">
        ...
        >
          <div className="welcome-badge">BEM-VINDO AO PLANTA GAMER</div>
          ...
          <p className="welcome-text">
            ...
            Responda 10 perguntas por dia e veja seu conhecimento evoluir.
          </p>
        </motion.div>
        ...
        <div className="feature-grid">
          {[
            {
              icon: <Target size={20} className="text-[#005ab1]" />,
              title: "Desafio Diário",
              desc: "Responda 10 questões por dia para manter o foco.",
            },
            {
              icon: <Leaf size={20} className="text-emerald-600" />,
              title: "Evolução Visual",
              desc: "Cada 5 níveis sua planta muda de forma e sprinte.",
            },
            {
              icon: <History size={20} className="text-amber-600" />,
              title: "Mecânica RPG",
              desc: "Ganhe ou perca níveis baseando-se no seu desempenho.",
            },
          ].map((item, idx) => (
            <motion.div
              key={idx}
